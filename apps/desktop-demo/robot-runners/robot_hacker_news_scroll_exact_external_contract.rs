...
use text_showcase_external_helpers::scroll_text_into_view;

const WINDOW_WIDTH: u32 = 900;
const WINDOW_HEIGHT: u32 = 700;
const WINDOW_TITLE: &str = "Robot Hacker News Scroll Exact External";
    ...
    AppLauncher::new()
        ...
        .with_test_driver(move |robot| {
            ...
            scroll_text_into_view(
                &robot,
                app::HACKER_NEWS_SCROLL_STABILITY_TARGET_TITLE,
                WINDOW_HEIGHT,
                48,
            );
            ...
            let compare_ok = run_scroll_stability_capture(
                ...
                ScrollStabilityConfig {
                    ...
                    output_name: "hacker_news_scroll_exact_external",
                    file_prefix: "hacker_news_scroll",
                    target_text: app::HACKER_NEWS_SCROLL_STABILITY_TARGET_TITLE,
                    viewport_tag: Some("HackerNewsList"),
            ...
            println!("\n=== Test Summary ===");
            println!(
                "PASS: Hacker News list content stayed pixel-identical in the overlapping region"
            );

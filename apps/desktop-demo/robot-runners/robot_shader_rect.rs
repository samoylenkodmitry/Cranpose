...
const MAX_SHADER_RECT_CONTENT_PASSES: u32 = 4;
const PRESENTATION_PASSES: u32 = 1;
const MAX_SHADER_RECT_PASSES: u32 = MAX_SHADER_RECT_CONTENT_PASSES + PRESENTATION_PASSES;

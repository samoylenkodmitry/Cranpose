...
#[test]
#[ignore = "manual structural stress case; normal CI covers the bounded variant"]
fn perf_ignored_massive_keyed_reorder_stress() {
    const PARENT_KEY: Key = 8_070;
    const CHILD_KEY: Key = 8_071;
    const CHILD_COUNT: Key = 512;

...
struct SlotMemoryPlateau {
    ...
    payload_anchor_index_count: usize,
    payload_anchor_index_capacity: usize,
    node_count: usize,
    node_capacity: usize,
...
impl From<SlotTableDebugStats> for SlotMemoryPlateau {
    fn from(stats: SlotTableDebugStats) -> Self {
        Self {
            ...
            payload_anchor_index_count: stats.payload_anchor_index_count,
            payload_anchor_index_capacity: stats.payload_anchor_index_capacity,

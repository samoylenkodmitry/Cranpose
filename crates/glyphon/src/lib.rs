...
pub struct TextArea<'a> {
    ...
    pub top: f32,
    /// The horizontal origin used when choosing glyph rasterization phases.
    pub cache_left: f32,
    /// The vertical origin used when choosing glyph rasterization phases.
    pub cache_top: f32,
    /// Whether to preserve subpixel Y when building glyph cache keys.
    pub subpixel_y: bool,

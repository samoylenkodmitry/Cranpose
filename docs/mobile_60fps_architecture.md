...
| Cranscan | Huawei 52.36→54.04 FPS with a persistent blank body; watch 35.03→27.15 with one missed route and a timing overrun | Resolve [Huawei correctness #620](https://github.com/samoylenkodmitry/Cranpose/issues/620) and [watch regression #621](https://github.com/samoylenkodmitry/Cranpose/issues/621); diagnostic means do not establish acceptance |

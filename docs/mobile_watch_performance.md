...
| CPU profiles: 22.60 before swipe, 18.59 after swipe, 17.87 after inlining; latest arc recorder 4.70 ms/frame, draw scope 1.40 | `watch-direct-columns-opening-cpu/`, `watch-swipe-layout-v1-opening-cpu/`, `watch-swipe-inline-normalization-v1-opening-cpu/`; separate diagnostics, profiling overhead included |

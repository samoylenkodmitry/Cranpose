...
| I/O/diagnostics | Buffer repeated I/O, reuse parsing buffers and keep disabled logging cheap. Preserve validation and errors. | Syscalls and instrumentation overhead. Group counters used in ratios; check running coverage and output freshness. Disable instrumentation for acceptance. [I/O][io] |
